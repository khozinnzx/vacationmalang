...
//        if (mLokasiUser.size() == 0) {
//            {
//                if (getArguments() != null) {
//
//                    final ArrayList<LokasiUser> lokasi = getArguments().getParcelableArrayList(getString(R.string.intent_user_locations));
//                    mLokasiUser.addAll(lokasi);
//                }
//            }
//
//
